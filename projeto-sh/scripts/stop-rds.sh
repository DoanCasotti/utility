...
echo "🛑 Desligando RDS ($DB_IDENTIFIER)..."
aws rds stop-db-instance --db-instance-identifier "$DB_IDENTIFIER" --region "$AWS_REGION" &> /dev/null
echo "✅ RDS sendo desligado (leva ~2 minutos)"
echo "ℹ️  Será religado automaticamente após 7 dias"
